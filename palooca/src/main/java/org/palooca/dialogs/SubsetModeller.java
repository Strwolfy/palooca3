...
public class SubsetModeller extends PaloDialogUtilities {
    ...
    private void initComponents() {
        ...
        cmbAlias1 = new JComboBox();
        cmbAlias2 = new JComboBox();
        ...
        jPanel2.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());

        jTabbedPane1.setName("jTabbedPane1"); // NOI18N

        panelGeneral.setName("panelGeneral"); // NOI18N
        panelGeneral.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        panelGeneral.add(jPanel3, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, 200, 130));
        ...
        panelGeneral.add(jPanel4, new org.palooca.dialogs.awtextra.AbsoluteConstraints(220, 10, 270, 130));
        ...
        panelGeneral.add(jPanel5, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 150, 200, 100));
        ...
        panelGeneral.add(jPanel6, new org.palooca.dialogs.awtextra.AbsoluteConstraints(220, 150, 270, 100));
        ...
        panelGeneral.add(jPanel7, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 260, 200, 80));

        jTabbedPane1.addTab(bundle.getString("General"), panelGeneral); // NOI18N

        panelHierarchy.setName("panelHierarchy"); // NOI18N
        panelHierarchy.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        panelHierarchy.add(chkActivateHierarchy, new org.palooca.dialogs.awtextra.AbsoluteConstraints(310, 10, -1, -1));

        jTabbedPane1.addTab(bundle.getString("Hierarchy"), panelHierarchy); // NOI18N

        panelText.setName("panelText"); // NOI18N
        panelText.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        panelText.add(chkActivateText, new org.palooca.dialogs.awtextra.AbsoluteConstraints(310, 10, -1, -1));
        ...
        panelSort.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());

        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("RevertInstruction"))); // NOI18N
        jPanel8.setName("jPanel8"); // NOI18N
        jPanel8.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        jPanel8.add(chkReverse, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 20, -1, 20));

        panelSort.add(jPanel8, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 180, 480, 50));

        jTabbedPane1.addTab(bundle.getString("Sort"), panelSort); // NOI18N

        jPanel2.add(jTabbedPane1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, 510, 490));

        jLabel2.setText(bundle.getString("Preview")); // NOI18N
        jLabel2.setName("jLabel2"); // NOI18N
        jPanel2.add(jLabel2, new org.palooca.dialogs.awtextra.AbsoluteConstraints(530, 10, -1, -1));
        ...
        jPanel2.add(jScrollPane1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(530, 30, 170, 470));

        jSplitPane1.setRightComponent(jPanel2);

        getContentPane().add(jSplitPane1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(0, 0, 880, 510));
        ...
        getContentPane().add(btnSave, new org.palooca.dialogs.awtextra.AbsoluteConstraints(500, 520, 90, -1));
        ...
        getContentPane().add(btnClose, new org.palooca.dialogs.awtextra.AbsoluteConstraints(590, 520, 90, -1));
        ...
        getContentPane().add(btnSubsetNew, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 520, 30, -1));
        ...
        getContentPane().add(btnSubsetDelete, new org.palooca.dialogs.awtextra.AbsoluteConstraints(50, 520, 30, -1));

        btnSubsetEdit.setIcon(resourceMap.getIcon("btnSubsetEdit.icon")); // NOI18N
        btnSubsetEdit.setName("btnSubsetEdit"); // NOI18N
        getContentPane().add(btnSubsetEdit, new org.palooca.dialogs.awtextra.AbsoluteConstraints(90, 520, 30, -1));

        txtFormula.setText(resourceMap.getString("txtFormula.text")); // NOI18N
        txtFormula.setName("txtFormula"); // NOI18N
        getContentPane().add(txtFormula, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 560, 860, 20));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void cmbDatabaseItemStateChanged(ItemEvent evt) {//GEN-FIRST:event_cmbDatabaseItemStateChanged
        comboDatabaseChangeEvent(evt, null);
    }//GEN-LAST:event_cmbDatabaseItemStateChanged

    private void cmbDimensionItemStateChanged(ItemEvent evt) {//GEN-FIRST:event_cmbDimensionItemStateChanged
...
*/
    ...
    private JComboBox cmbAlias1;
    private JComboBox cmbAlias2;
    ...
    private SubsetList subsetList1;
