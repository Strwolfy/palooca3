...
public class InsertElementDialog extends PaloDialogUtilities
    ...
    private final DefaultListModel dimensionModel = new DefaultListModel();
...
//        setIconImage(new ImageIcon(InsertElementDialog.class.getResource("/images/InsertElements.PNG")).getImage());
    ...
    private void initComponents() {
        ...
        jLabel2 = new JLabel();
        comboBoxDimensions = new JComboBox();
        jButtonExpandAll = new JButton();
        jButtonCollapseAll = new JButton();
        jButtonCollapse = new JButton();
        jButtonExpand = new JButton();
        jLabel3 = new JLabel();
        jButtonSelectAll = new JButton();
        jButtonSelect1 = new JButton();
        jButtonSelect2 = new JButton();
        jButtonSelect3 = new JButton();
        jButtonSelect4 = new JButton();
        jButtonSelect5 = new JButton();
        jButtonSelectB = new JButton();
        jTextFieldSearch = new JTextField();
        jButtonSearch = new JButton();
        jButtonSelectChildren = new JButton();
        jScrollPane1 = new JScrollPane();
        treeElements = new JTree();
        jButtonMoveRight = new JButton();
        jButtonMoveLeft = new JButton();
        jButtonMoveUp = new JButton();
        jButtonMoveDown = new JButton();
        jLabel4 = new JLabel();
        jButtonSortUp = new JButton();
        jButtonSortDown = new JButton();
        jButtonClear = new JButton();
        jScrollPane2 = new JScrollPane();
        jListElements = new JList();
        jLabel5 = new JLabel();
        cmbAlias = new JComboBox();
        jLabel6 = new JLabel();
        cmbAliasFormat = new JComboBox();
        jLabel7 = new JLabel();
        btnInvertSelection = new JButton();
        jPanelMetaData = new JPanel();
        radioButtonInsertConnection = new JRadioButton();
        radioButtonInsertCubeName = new JRadioButton();
        lblCube = new JLabel();
        comboBoxCube = new JComboBox();
        btnDataCubes = new JToggleButton();
        btnAttributeCubes = new JToggleButton();
        btnUserCubes = new JToggleButton();
        radioButtonInsertDimensionName = new JRadioButton();
        jScrollPane3 = new JScrollPane();
        listDimensions = new JList();
        btnPasteHorizontally = new JButton();
        btnPasteVertically = new JButton();
        ...
        jPanelElements.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());

        jLabel2.setText(bundle.getString("SelectDimension")); // NOI18N
        jLabel2.setName("jLabel2"); // NOI18N
        jPanelElements.add(jLabel2, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        jPanelElements.add(comboBoxDimensions, new org.palooca.dialogs.awtextra.AbsoluteConstraints(90, 10, 160, -1));

        jButtonExpandAll.setIcon(new ImageIcon(getClass().getResource("/images/expandAll.png"))); // NOI18N
        ...
        jPanelElements.add(jButtonExpandAll, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 70, 25, -1));

        jButtonCollapseAll.setIcon(new ImageIcon(getClass().getResource("/images/collapseAll.png"))); // NOI18N
        ...
        jPanelElements.add(jButtonCollapseAll, new org.palooca.dialogs.awtextra.AbsoluteConstraints(40, 70, 25, -1));
        ...
        jPanelElements.add(jButtonCollapse, new org.palooca.dialogs.awtextra.AbsoluteConstraints(110, 70, 25, -1));
        ...
        jPanelElements.add(jButtonExpand, new org.palooca.dialogs.awtextra.AbsoluteConstraints(80, 70, 25, -1));

        jLabel3.setText(bundle.getString("Hierarchy")); // NOI18N
        jLabel3.setName("jLabel3"); // NOI18N
        jPanelElements.add(jLabel3, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 50, -1, -1));
        ...
        jPanelElements.add(jButtonSelectAll, new org.palooca.dialogs.awtextra.AbsoluteConstraints(260, 390, 120, -1));
        ...
        jPanelElements.add(jButtonSelect1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(260, 420, -1, -1));
        ...
        jPanelElements.add(jButtonSelect2, new org.palooca.dialogs.awtextra.AbsoluteConstraints(280, 420, -1, -1));
        ...
        jPanelElements.add(jButtonSelect3, new org.palooca.dialogs.awtextra.AbsoluteConstraints(300, 420, -1, -1));
        ...
        jPanelElements.add(jButtonSelect4, new org.palooca.dialogs.awtextra.AbsoluteConstraints(320, 420, -1, -1));
        ...
        jPanelElements.add(jButtonSelect5, new org.palooca.dialogs.awtextra.AbsoluteConstraints(340, 420, -1, -1));
        ...
        jPanelElements.add(jButtonSelectB, new org.palooca.dialogs.awtextra.AbsoluteConstraints(365, 420, -1, -1));

        jTextFieldSearch.setName("jTextFieldSearch"); // NOI18N
        jPanelElements.add(jTextFieldSearch, new org.palooca.dialogs.awtextra.AbsoluteConstraints(260, 450, 120, -1));
        ...
        jPanelElements.add(jButtonSearch, new org.palooca.dialogs.awtextra.AbsoluteConstraints(390, 450, 140, -1));
        ...
        jPanelElements.add(jButtonSelectChildren, new org.palooca.dialogs.awtextra.AbsoluteConstraints(390, 390, 140, -1));
        ...
        jPanelElements.add(jScrollPane1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 100, 200, 330));

        jButtonMoveRight.setIcon(new ImageIcon(getClass().getResource("/images/MoveNext.png"))); // NOI18N
        ...
        jPanelElements.add(jButtonMoveRight, new org.palooca.dialogs.awtextra.AbsoluteConstraints(220, 180, 25, -1));

        jButtonMoveLeft.setIcon(new ImageIcon(getClass().getResource("/images/MovePrevious.png"))); // NOI18N
        ...
        jPanelElements.add(jButtonMoveLeft, new org.palooca.dialogs.awtextra.AbsoluteConstraints(220, 220, 25, -1));

        jButtonMoveUp.setIcon(new ImageIcon(getClass().getResource("/images/MoveUp.png"))); // NOI18N
        ...
        jPanelElements.add(jButtonMoveUp, new org.palooca.dialogs.awtextra.AbsoluteConstraints(220, 140, 25, -1));

        jButtonMoveDown.setIcon(new ImageIcon(getClass().getResource("/images/MoveDown.PNG"))); // NOI18N
        ...
        jPanelElements.add(jButtonMoveDown, new org.palooca.dialogs.awtextra.AbsoluteConstraints(220, 260, 25, -1));

        jLabel4.setText(bundle.getString("PickList")); // NOI18N
        jLabel4.setName("jLabel4"); // NOI18N
        jPanelElements.add(jLabel4, new org.palooca.dialogs.awtextra.AbsoluteConstraints(260, 50, -1, -1));
        ...
        jPanelElements.add(jButtonSortUp, new org.palooca.dialogs.awtextra.AbsoluteConstraints(260, 70, 83, -1));
        ...
        jPanelElements.add(jButtonSortDown, new org.palooca.dialogs.awtextra.AbsoluteConstraints(350, 70, 90, -1));
        ...
        jPanelElements.add(jButtonClear, new org.palooca.dialogs.awtextra.AbsoluteConstraints(450, 70, 80, -1));
        ...
        jPanelElements.add(jScrollPane2, new org.palooca.dialogs.awtextra.AbsoluteConstraints(260, 100, 270, 280));

        jLabel5.setText(bundle.getString("UseAlias")); // NOI18N
        jLabel5.setName("jLabel5"); // NOI18N
        jPanelElements.add(jLabel5, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 440, -1, -1));
        ...
        jPanelElements.add(cmbAlias, new org.palooca.dialogs.awtextra.AbsoluteConstraints(90, 440, 120, -1));

        jLabel6.setText(bundle.getString("AliasFormat")); // NOI18N
        jLabel6.setName("jLabel6"); // NOI18N
        jPanelElements.add(jLabel6, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 470, -1, -1));

        cmbAliasFormat.setModel(new DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        jPanelElements.add(cmbAliasFormat, new org.palooca.dialogs.awtextra.AbsoluteConstraints(90, 470, 120, -1));

        jLabel7.setText(bundle.getString("ShiftTip")); // NOI18N
        jLabel7.setName("jLabel7"); // NOI18N
        jPanelElements.add(jLabel7, new org.palooca.dialogs.awtextra.AbsoluteConstraints(260, 480, -1, -1));
        ...
        jPanelElements.add(btnInvertSelection, new org.palooca.dialogs.awtextra.AbsoluteConstraints(390, 420, 140, -1));
        ...
        btnDataCubes.setIcon(new ImageIcon(getClass().getResource("/images/cube.png"))); // NOI18N
        ...
        btnAttributeCubes.setIcon(new ImageIcon(getClass().getResource("/images/attribute.png"))); // NOI18N
        ...
        btnUserCubes.setIcon(new ImageIcon(getClass().getResource("/images/user.png"))); // NOI18N
        ...
        btnPasteHorizontally.setIcon(new ImageIcon(getClass().getResource("/images/hinsert.PNG"))); // NOI18N
        btnPasteHorizontally.setText(bundle.getString("PasteHorizontally")); // NOI18N
        btnPasteHorizontally.setHorizontalTextPosition(SwingConstants.LEFT);
        ...
        btnPasteVertically.setIcon(new ImageIcon(getClass().getResource("/images/vinsert.PNG"))); // NOI18N
        btnPasteVertically.setText(bundle.getString("PasteVertically")); // NOI18N
        btnPasteVertically.setHorizontalTextPosition(SwingConstants.LEFT);
    ...
    private void jButtonSelect5ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonSelect5ActionPerformed
        selectByLevel(5, ((evt.getModifiers() & ActionEvent.SHIFT_MASK) != 0));
    ...
    private void jButtonSelectChildrenActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonSelectChildrenActionPerformed
        ...
        for (int i = 0; i < Objects.requireNonNull(path).length; i++) {
    ...
    private void jButtonMoveRightActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonMoveRightActionPerformed
        ...
        for (int selRow : selRows) {
            TreePath path = treeElements.getPathForRow(selRow);
    ...
    private void jButtonMoveUpActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonMoveUpActionPerformed
        ...
        for (int selRow : selRows) {
            if (selRow > 0) {
                obj = elementModel.get(selRow);
                elementModel.remove(selRow);
                elementModel.insertElementAt(obj, selRow - 1);
                jListElements.addSelectionInterval(selRow - 1, selRow - 1);
            }
        }
    ...
    private void btnDataCubesActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnDataCubesActionPerformed
        buildCubeList(ICube.CubeType.CUBE_NORMAL, comboBoxCube);
}//GEN-LAST:event_btnDataCubesActionPerformed

    private void btnAttributeCubesActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnAttributeCubesActionPerformed
        buildCubeList(ICube.CubeType.CUBE_ATTRIBUTE, comboBoxCube);
}//GEN-LAST:event_btnAttributeCubesActionPerformed

    private void btnUserCubesActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnUserCubesActionPerformed
        buildCubeList(ICube.CubeType.CUBE_SYSTEM, comboBoxCube);
}//GEN-LAST:event_btnUserCubesActionPerformed

    private void comboDatabaseChange(ItemEvent evt) {//GEN-FIRST:event_comboDatabaseChange
        comboDatabaseChangeEvent(evt, comboBoxCube);
    }//GEN-LAST:event_comboDatabaseChange

    private void comboDimensionChanged(ItemEvent evt) {//GEN-FIRST:event_comboDimensionChanged
    ...
    private void btnPasteHorizontallyActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnPasteHorizontallyActionPerformed
        insertElements(true);
        setVisible(false);
        dispose();
    }//GEN-LAST:event_btnPasteHorizontallyActionPerformed

    private void btnPasteVerticallyActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnPasteVerticallyActionPerformed
    ...
    private void cmbAliasFormatItemStateChanged(ItemEvent evt) {//GEN-FIRST:event_cmbAliasFormatItemStateChanged
        if (evt.getStateChange() == ItemEvent.SELECTED) {
    ...
    private void insertElements(boolean horizontally) {
        ...
        if (paths != null || data != null) {
            XCellRangeAddressable cellRangeAddressable = UnoRuntime.queryInterface(XCellRangeAddressable.class, selectedRange);
...
//            }
    ...
    private JToggleButton btnAttributeCubes;
    private JButton btnCancel;
    private JToggleButton btnDataCubes;
    private JButton btnInvertSelection;
    private JButton btnPasteHorizontally;
    private JButton btnPasteVertically;
    private JToggleButton btnUserCubes;
    private JComboBox cmbAlias;
    private JComboBox cmbAliasFormat;
    private JComboBox comboBoxCube;
    private JComboBox comboBoxDatabase;
    private JComboBox comboBoxDimensions;
    ...
    private JButton jButtonSelect1;
    private JButton jButtonSelect2;
    private JButton jButtonSelect3;
    private JButton jButtonSelect4;
    private JButton jButtonSelect5;
    private JButton jButtonSelectAll;
    private JButton jButtonSelectB;
    private JButton jButtonSelectChildren;
    private JButton jButtonSortDown;
    private JButton jButtonSortUp;      // 20 + 4 JButton
    ...
    private JList listDimensions;
    private JRadioButton radioButtonInsertConnection;
    private JRadioButton radioButtonInsertCubeName;
    private JRadioButton radioButtonInsertDimensionName;
