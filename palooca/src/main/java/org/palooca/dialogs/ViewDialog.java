...
//            btnUserCubes.setEnabled(true);
    ...
    private void initComponents() {
        ...
        dimensionSubsetListRow = new DimensionSubsetList();
        jPanel3 = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        dimensionSubsetListFilter = new DimensionSubsetList();
        jPanel4 = new javax.swing.JPanel();
        lblDatabase = new javax.swing.JLabel();
        lblCube = new javax.swing.JLabel();
        comboBoxCube = new JComboBox();
        ...
        jComboBoxFunction = new JComboBox();
        ...
        dimensionSubsetListColumn = new DimensionSubsetList();
        ...
        getContentPane().add(jPanel1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 340, 280, 230));
        ...
        getContentPane().add(jPanel3, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 100, 280, 230));
        ...
        getContentPane().add(jPanel4, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, 570, 80));
        ...
        getContentPane().add(btnCreate, new org.palooca.dialogs.awtextra.AbsoluteConstraints(600, 20, 90, -1));
        ...
        getContentPane().add(btnCancel, new org.palooca.dialogs.awtextra.AbsoluteConstraints(600, 50, 90, -1));
        ...
        getContentPane().add(jPanel5, new org.palooca.dialogs.awtextra.AbsoluteConstraints(300, 340, 280, 230));
        ...
        getContentPane().add(jPanel2, new org.palooca.dialogs.awtextra.AbsoluteConstraints(300, 100, 280, 230));
        ...
        getContentPane().add(jPanel6, new org.palooca.dialogs.awtextra.AbsoluteConstraints(660, 540, 40, 40));
    ...
    private void comboBoxCubeItemStateChanged(ItemEvent evt) {//GEN-FIRST:event_comboBoxCubeItemStateChanged
    ...
    private void jComboBoxDatabaseItemStateChanged(ItemEvent evt) {//GEN-FIRST:event_jComboBoxDatabaseItemStateChanged
...
//            btnUserCubes.setEnabled(false);
    ...
    private JComboBox comboBoxCube;
    private DimensionSubsetList dimensionSubsetListColumn;
    private DimensionSubsetList dimensionSubsetListFilter;
    private DimensionSubsetList dimensionSubsetListRow;
    ...
    private JComboBox jComboBoxFunction;
