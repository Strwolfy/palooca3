...
public class Modeller extends javax.swing.JDialog {
    ...
    private final DefaultTreeModel overviewTreeModel = new DefaultTreeModel(rootNode);
    ...
    private final DatabaseTreeNode rootNodeCubes = new DatabaseTreeNode(null,null);
    ...
    private final CubeRightTableListener cubeRightTableListener;
    ...
    public Modeller(Dialog parent, boolean modal, XComponentContext context) {
        super(parent, modal);
...
//        treeConsolidation.setEditable(true);
        ...
        public void editingStopped(ChangeEvent e) {
            if (editDatabaseNode != null && editDatabaseNode.getDatabase() == null) {
                try {
                    ...
                    JOptionPane.showMessageDialog(dialog, pe.getMessage(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                ...
                try {
                    if (editDimNode.getDimension().getName().equalsIgnoreCase(name) == false) {
                        if (editDimNode.getDatabase().getDimensionByName(name) == null && name.length() > 0) {
                            ...
                            JOptionPane.showMessageDialog(dialog, ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Invalid_Dimension_Name."), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                        }
                    }
                } catch (PaloJException pe) {
                    JOptionPane.showMessageDialog(dialog, pe.getMessage(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                } catch (PaloException pe) {
                    JOptionPane.showMessageDialog(dialog, pe.getDescription() + ", " + pe.getReason(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                }
                buildOverview(false);
                ...
                try {
                    if (editCubeNode.getCube().getName().equalsIgnoreCase(name) == false) {
                        if (editCubeNode.getDatabase().getCubeByName(name) == null && name.length() > 0) {
                            ...
                            JOptionPane.showMessageDialog(dialog, ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Invalid_Cube_Name."), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                        }
                    }
                } catch (PaloJException pe) {
                    JOptionPane.showMessageDialog(dialog, pe.getMessage(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                ...
                try {
                    if (editElementNode.getElement().getName().equalsIgnoreCase(name) == false) {
                        if (editElementNode.getDimension().getElementByName(name,false) == null && name.length() > 0) {
                            ...
                            JOptionPane.showMessageDialog(dialog, ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Invalid_Element_Name."), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                        }
                    }
                } catch (PaloJException pe) {
                    JOptionPane.showMessageDialog(dialog, pe.getMessage(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                ...
                try {
                    if (editGroupNode.getGroup().getElement().getName().equalsIgnoreCase(name) == false) {
                        if (editGroupNode.getDimension().getElementByName(name,false) == null && name.length() > 0) {
                            ...
                            JOptionPane.showMessageDialog(dialog, ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Invalid_Group_Name."), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                        }
                    }
                } catch (PaloJException pe) {
                    JOptionPane.showMessageDialog(dialog, pe.getMessage(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                ...
                try {
                    if (editUserNode.getUser().getElement().getName().equalsIgnoreCase(name) == false) {
                        if (editUserNode.getDimension().getElementByName(name,false) == null &&
                            ...
                            JOptionPane.showMessageDialog(dialog, ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Invalid_User_Name."), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                        }
                    }
                } catch (PaloJException pe) {
                    JOptionPane.showMessageDialog(dialog, pe.getMessage(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                ...
                try {
                    if (editRoleNode.getRole().getElement().getName().equalsIgnoreCase(name) == false) {
                        if (editRoleNode.getDimension().getElementByName(name,false) == null && name.length() > 0) {
                            ...
                            JOptionPane.showMessageDialog(dialog, ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Invalid_Role_Name."), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                        }
                    }
                } catch (PaloJException pe) {
                    JOptionPane.showMessageDialog(dialog, pe.getMessage(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
    ...
    private void buildOverview(boolean initial)
    {
        ...
        for (ConnectionInfo connectionInfo : info) {
            ConnectionTreeNode cNode = new ConnectionTreeNode(connectionInfo);
            rootNode.add(cNode);
            if (initial) {
                if (connectionInfo.isAutoLogin()) {
                    connectionInfo.connect(this, 2000);
                }
            }
            if (connectionInfo.getState() == ConnectionState.Connected) {
                ...
                if (connection != null) {
                    ...
                    for (IDatabase db : dbs) {
                        ...
                        if (db.getType().equals(IDatabase.DatabaseType.DATABASE_NORMAL)) {
                            DatabaseTreeNode dbNode = new DatabaseTreeNode(db, connection);
                            cNode.add(dbNode);
    ...
    private void addGroups(ConnectionTreeNode cNode, IDatabase sysDB)
    {
        ...
        for (PaloGroup group : groups) {
            GroupTreeNode groupNode =
                    new GroupTreeNode(group, admin.getDimensionByName(PaloAdministration.DIMENSION_GROUP));
...
// Comparison is done using String.equals(). Returns null if not found.
    ...
    private void deleteSelectedDimension()
    {
        ...
        if (node instanceof DimensionTreeNode) {
            try {
                ...
                JOptionPane.showMessageDialog(this, pe.getMessage(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
            } catch (PaloException pe) {
                JOptionPane.showMessageDialog(this, pe.getDescription() + ", " + pe.getReason(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
            }
        }
        updateDatabasePanelButtonStates();
        buildOverview(false);
    ...
    private void createDimension()
    {
        ...
        if (dbNode != null) {
            try {
                IDatabase db = dbNode.getDatabase();
                String name = ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("NewDimension");
                int i =  1;
    ...
    private void createDatabase() {
        ...
        if (node instanceof ConnectionTreeNode) {
            try  {
                ...
                IConnection connection =  con.getConnection();
                if (connection != null) {
                    String name = ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("NewDatabase");
                    int i =  1;
    ...
    private void deleteSelectedDatabase() {
        if (JOptionPane.showConfirmDialog(this, ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Delete_selected_Database?"), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Confirmation"), JOptionPane.OK_CANCEL_OPTION) == JOptionPane.CANCEL_OPTION)
            return;
    ...
    private void deleteSelectedElement()
    {
        ...
        int ret = JOptionPane.showConfirmDialog(this,
                ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Delete_selected_Element?"),
                ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Confirmation"), JOptionPane.OK_CANCEL_OPTION);
    ...
    private void createElement()
    {
        try {
            ...
            String name = ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("NewElement");
            int i =  1;
    ...
    {
        if (JOptionPane.showConfirmDialog(this, ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Delete_selected_Cube?"), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Confirmation"), JOptionPane.OK_CANCEL_OPTION) == JOptionPane.CANCEL_OPTION)
            return;
    ...
    private void createGroup()
    {
        try {
            ...
            String name = ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("NewGroup");
            int i =  1;
    ...
    private void createUser()
    {
        try {
            ...
            String name = ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("NewUser");
            int i =  1;
    ...
    private void createRole()
    {
        try {
            ...
            String name = ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("NewRole");
            int i =  1;
    ...
    private void createAttribute()
    {
        try {
            IDimension dim = rootNodeAttributes.getDimension();
            String name = ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("NewAttribute");
            int i =  1;
    ...
    private class GroupRoleTableListener implements TableModelListener {
        ...
        public void tableChanged(TableModelEvent e) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, pe.getMessage(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
            } catch (PaloException pe) {
                JOptionPane.showMessageDialog(null, pe.getDescription() + ", " + pe.getReason(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private class RoleRightTableListener implements TableModelListener {
        ...
        public void tableChanged(TableModelEvent e) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(Modeller.this, pe.getMessage(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                int     pos = jSplitPane1.getDividerLocation();
                showRolePanel();
                jSplitPane1.setDividerLocation(pos);
            } catch (PaloException pe) {
                JOptionPane.showMessageDialog(Modeller.this, pe.getDescription() + ", " + pe.getReason(), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setAlwaysOnTop(true);
        setResizable(false);
        getContentPane().setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        getContentPane().add(jToolBar1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        getContentPane().add(btnOK, new org.palooca.dialogs.awtextra.AbsoluteConstraints(730, 470, 80, -1));
        ...
        panelAttribute.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        panelAttribute.add(btnEditAttributes, new org.palooca.dialogs.awtextra.AbsoluteConstraints(20, 70, 170, -1));

        jLabel37.setText(bundle.getString("EditDimRightsInfo2")); // NOI18N
        jLabel37.setName("jLabel37"); // NOI18N
        panelAttribute.add(jLabel37, new org.palooca.dialogs.awtextra.AbsoluteConstraints(20, 40, -1, -1));

        jLabel38.setText(bundle.getString("EditAttributeValuesInfo")); // NOI18N
        jLabel38.setName("jLabel38"); // NOI18N
        panelAttribute.add(jLabel38, new org.palooca.dialogs.awtextra.AbsoluteConstraints(20, 20, 570, 20));

        jSplitPane1.setRightComponent(panelAttribute);

        panelDatabase.setName("panelDatabase"); // NOI18N
        panelDatabase.setPreferredSize(new java.awt.Dimension(550, 395));
        panelDatabase.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());

        jLabel8.setText(bundle.getString("Dimensions")); // NOI18N
        jLabel8.setName("jLabel8"); // NOI18N
        panelDatabase.add(jLabel8, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        jLabel9.setText(bundle.getString("Cubes")); // NOI18N
        jLabel9.setName("jLabel9"); // NOI18N
        panelDatabase.add(jLabel9, new org.palooca.dialogs.awtextra.AbsoluteConstraints(270, 10, -1, -1));
        ...
        panelDatabase.add(btnCreateDimension, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 370, 25, -1));
        ...
        panelDatabase.add(btnDeleteDimension, new org.palooca.dialogs.awtextra.AbsoluteConstraints(40, 370, 25, -1));
        ...
        panelDatabase.add(btnRenameDimension, new org.palooca.dialogs.awtextra.AbsoluteConstraints(70, 370, 25, -1));
        ...
        panelDatabase.add(btnCreateCube, new org.palooca.dialogs.awtextra.AbsoluteConstraints(270, 370, 25, -1));
        ...
        panelDatabase.add(btnDeleteCube, new org.palooca.dialogs.awtextra.AbsoluteConstraints(300, 370, 25, -1));
        ...
        panelDatabase.add(jScrollPane3, new org.palooca.dialogs.awtextra.AbsoluteConstraints(270, 30, 250, 330));
        ...
        panelDatabase.add(jScrollPane4, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 30, 230, 330));
        ...
        panelDatabase.add(btnRenameCube, new org.palooca.dialogs.awtextra.AbsoluteConstraints(330, 370, 25, -1));

        jSplitPane1.setRightComponent(panelDatabase);

        panelDimension.setName("panelDimension"); // NOI18N
        panelDimension.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());

        jLabel11.setText(bundle.getString("Elements")); // NOI18N
        jLabel11.setName("jLabel11"); // NOI18N
        panelDimension.add(jLabel11, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 20, -1, -1));
        ...
        panelDimension.add(jScrollPane2, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 40, 235, -1));
        ...
        panelDimension.add(btnSortDown, new org.palooca.dialogs.awtextra.AbsoluteConstraints(220, 10, 25, -1));
        ...
        panelDimension.add(btnSortUp, new org.palooca.dialogs.awtextra.AbsoluteConstraints(190, 10, 25, -1));
        ...
        panelDimension.add(btnNoSort, new org.palooca.dialogs.awtextra.AbsoluteConstraints(160, 10, 25, -1));
        ...
        panelDimension.add(jScrollPane5, new org.palooca.dialogs.awtextra.AbsoluteConstraints(300, 40, 230, -1));

        jLabel12.setText(bundle.getString("ConsolidatedElements")); // NOI18N
        jLabel12.setName("jLabel12"); // NOI18N
        panelDimension.add(jLabel12, new org.palooca.dialogs.awtextra.AbsoluteConstraints(300, 20, -1, -1));
        ...
        panelDimension.add(btnMoveUp, new org.palooca.dialogs.awtextra.AbsoluteConstraints(260, 130, 25, -1));
        ...
        panelDimension.add(btnMoveRight, new org.palooca.dialogs.awtextra.AbsoluteConstraints(260, 210, 25, -1));
        ...
        panelDimension.add(btnMoveLeft, new org.palooca.dialogs.awtextra.AbsoluteConstraints(260, 240, 25, -1));
        ...
        panelDimension.add(btnMoveDown, new org.palooca.dialogs.awtextra.AbsoluteConstraints(260, 160, 25, -1));
        ...
        panelDimension.add(btnElementNew, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 370, 25, -1));
        ...
        panelDimension.add(btnElementDelete, new org.palooca.dialogs.awtextra.AbsoluteConstraints(40, 370, 25, -1));
        ...
        panelDimension.add(btnElementRename, new org.palooca.dialogs.awtextra.AbsoluteConstraints(70, 370, 25, -1));
        ...
        panelDimension.add(btnHierarchy, new org.palooca.dialogs.awtextra.AbsoluteConstraints(500, 10, 25, -1));
        ...
        panelDimension.add(btnConsolidationCancel, new org.palooca.dialogs.awtextra.AbsoluteConstraints(330, 370, 25, -1));
        ...
        panelDimension.add(btnConsolidationOK, new org.palooca.dialogs.awtextra.AbsoluteConstraints(300, 370, 25, -1));
        ...
        panelDimension.add(btnElementConsolidate, new org.palooca.dialogs.awtextra.AbsoluteConstraints(100, 370, 25, -1));
        ...
        panelDimension.add(btnElementString, new org.palooca.dialogs.awtextra.AbsoluteConstraints(220, 370, 25, -1));
        ...
        panelDimension.add(btnElementNumeric, new org.palooca.dialogs.awtextra.AbsoluteConstraints(190, 370, 25, -1));
        ...
        panelDimensionHierarchy.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        panelDimensionHierarchy.add(jScrollPane7, new org.palooca.dialogs.awtextra.AbsoluteConstraints(50, 42, 480, 350));
        ...
        panelDimensionHierarchy.add(btnFlat, new org.palooca.dialogs.awtextra.AbsoluteConstraints(500, 10, 30, -1));
        ...
        panelDimensionHierarchy.add(btnExpand, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 50, 25, -1));
        ...
        panelDimensionHierarchy.add(btnCollapse, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 80, 25, -1));
        ...
        panelDimensionHierarchy.add(btnCollapseAll, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 150, 25, -1));
        ...
        panelDimensionHierarchy.add(btnExpandAll, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 120, 25, -1));
        ...
        panelDimensionHierarchy.add(btnLevel1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(50, 10, 25, -1));
        ...
        panelDimensionHierarchy.add(btnLevel2, new org.palooca.dialogs.awtextra.AbsoluteConstraints(80, 10, 25, -1));
        ...
        panelDimensionHierarchy.add(btnLevel3, new org.palooca.dialogs.awtextra.AbsoluteConstraints(110, 10, 25, -1));
        ...
        panelDimensionHierarchy.add(btnLevel4, new org.palooca.dialogs.awtextra.AbsoluteConstraints(140, 10, 25, -1));
        ...
        panelDimensionHierarchy.add(btnLevel5, new org.palooca.dialogs.awtextra.AbsoluteConstraints(170, 10, 25, -1));
        ...
        panelDimensionHierarchy.add(btnLevel6, new org.palooca.dialogs.awtextra.AbsoluteConstraints(200, 10, 25, -1));
        ...
        panelDimensionHierarchy.add(btnLevel7, new org.palooca.dialogs.awtextra.AbsoluteConstraints(230, 10, 25, -1));
        ...
        panelDimensionHierarchy.add(btnLevel8, new org.palooca.dialogs.awtextra.AbsoluteConstraints(260, 10, 25, -1));
        ...
        panelDimensionHierarchy.add(btnWeight, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 200, 25, -1));

        jSplitPane1.setRightComponent(panelDimensionHierarchy);

        panelRules.setName("panelRules"); // NOI18N
        panelRules.setPreferredSize(new java.awt.Dimension(550, 395));
        panelRules.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());

        jLabel13.setText(bundle.getString("Rules")); // NOI18N
        jLabel13.setName("jLabel13"); // NOI18N
        panelRules.add(jLabel13, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        jLabel14.setText(bundle.getString("SelectedRule")); // NOI18N
        jLabel14.setName("jLabel14"); // NOI18N
        panelRules.add(jLabel14, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 210, -1, -1));
        ...
        panelRules.add(jScrollPane10, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 230, 530, 50));
        ...
        panelRules.add(btnNewRule, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 370, 25, -1));
        ...
        panelRules.add(btnDeleteRule, new org.palooca.dialogs.awtextra.AbsoluteConstraints(70, 370, 25, -1));
        ...
        panelRules.add(btnUpdateRule, new org.palooca.dialogs.awtextra.AbsoluteConstraints(40, 370, 25, -1));
        ...
        panelRules.add(btnRuleUp, new org.palooca.dialogs.awtextra.AbsoluteConstraints(510, 30, 25, -1));
        ...
        panelRules.add(btnRuleDown, new org.palooca.dialogs.awtextra.AbsoluteConstraints(510, 60, 25, -1));

        jLabel15.setText(bundle.getString("RuleComment")); // NOI18N
        jLabel15.setName("jLabel15"); // NOI18N
        panelRules.add(jLabel15, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 290, -1, -1));
        ...
        panelRules.add(jScrollPane11, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 310, 530, 50));

        txtError.setForeground(new Color(255, 0, 51));
        txtError.setName("txtError"); // NOI18N
        panelRules.add(txtError, new org.palooca.dialogs.awtextra.AbsoluteConstraints(150, 370, 390, 30));
        ...
        panelRules.add(btnCheckRule, new org.palooca.dialogs.awtextra.AbsoluteConstraints(110, 370, 25, -1));
        ...
        tableRules.setGridColor(new Color(204, 204, 204));
        ...
        panelRules.add(jScrollPane6, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 30, 490, 170));

        jSplitPane1.setRightComponent(panelRules);

        panelServer.setName("panelServer"); // NOI18N
        panelServer.setPreferredSize(new java.awt.Dimension(550, 395));
        panelServer.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        panelServer.add(jScrollPane8, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 30, 230, 330));

        jLabel2.setText(bundle.getString("Databases")); // NOI18N
        jLabel2.setName("jLabel2"); // NOI18N
        panelServer.add(jLabel2, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        panelServer.add(btnDatabaseNew, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 370, 25, -1));
        ...
        panelServer.add(btnDatabaseDelete, new org.palooca.dialogs.awtextra.AbsoluteConstraints(40, 370, 25, -1));
        ...
        panelGroups.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        panelGroups.add(jScrollPane12, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 30, 230, 330));

        jLabel16.setText(bundle.getString("Groups")); // NOI18N
        jLabel16.setName("jLabel16"); // NOI18N
        panelGroups.add(jLabel16, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        panelGroups.add(btnGroupNew, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 370, 25, -1));
        ...
        panelGroups.add(btnGroupDelete, new org.palooca.dialogs.awtextra.AbsoluteConstraints(40, 370, 25, -1));
        ...
        panelGroups.add(btnGroupEdit, new org.palooca.dialogs.awtextra.AbsoluteConstraints(70, 370, 25, -1));

        jSplitPane1.setRightComponent(panelGroups);

        panelUsers.setName("panelUsers"); // NOI18N
        panelUsers.setPreferredSize(new java.awt.Dimension(550, 395));
        panelUsers.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        panelUsers.add(jScrollPane13, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 30, 230, 330));

        jLabel17.setText(bundle.getString("Users")); // NOI18N
        jLabel17.setName("jLabel17"); // NOI18N
        panelUsers.add(jLabel17, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        panelUsers.add(btnUserNew, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 370, 25, -1));
        ...
        panelUsers.add(btnUserDelete, new org.palooca.dialogs.awtextra.AbsoluteConstraints(40, 370, 25, -1));
        ...
        panelUsers.add(btnUserEdit, new org.palooca.dialogs.awtextra.AbsoluteConstraints(70, 370, 25, -1));

        jSplitPane1.setRightComponent(panelUsers);

        panelRoles.setName("panelRoles"); // NOI18N
        panelRoles.setPreferredSize(new java.awt.Dimension(550, 395));
        panelRoles.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        panelRoles.add(jScrollPane14, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 30, 230, 330));

        jLabel18.setText(bundle.getString("Roles")); // NOI18N
        jLabel18.setName("jLabel18"); // NOI18N
        panelRoles.add(jLabel18, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        panelRoles.add(btnRoleNew, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 370, 25, -1));
        ...
        panelRoles.add(btnRoleDelete, new org.palooca.dialogs.awtextra.AbsoluteConstraints(40, 370, 25, -1));
        ...
        panelRoles.add(btnRoleEdit, new org.palooca.dialogs.awtextra.AbsoluteConstraints(70, 370, 25, -1));
        ...
        panelGroup.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        panelGroup.add(jScrollPane16, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 30, 330, 360));

        jLabel1.setText(bundle.getString("GroupRole")); // NOI18N
        jLabel1.setName("jLabel1"); // NOI18N
        panelGroup.add(jLabel1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        panelUser.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());

        jLabel4.setText(bundle.getString("UserGroup")); // NOI18N
        jLabel4.setName("jLabel4"); // NOI18N
        panelUser.add(jLabel4, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        panelUser.add(jScrollPane18, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 30, 330, 360));
        ...
        panelUser.add(btnPassword, new org.palooca.dialogs.awtextra.AbsoluteConstraints(370, 30, 130, -1));
        ...
        panelRole.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());

        jScrollPane17.setName("jScrollPane17"); // NOI18N

        tableRights.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        panelRole.add(jScrollPane17, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 30, 330, 360));

        jLabel3.setText(bundle.getString("RoleGroup")); // NOI18N
        jLabel3.setName("jLabel3"); // NOI18N
        panelRole.add(jLabel3, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        jLabel5.setText("Undefined: No Text"); // NOI18N
        jLabel5.setName("jLabel5"); // NOI18N
        panelRole.add(jLabel5, new org.palooca.dialogs.awtextra.AbsoluteConstraints(360, 160, -1, -1));

        jLabel6.setText("Splash      : S"); // NOI18N
        jLabel6.setName("jLabel6"); // NOI18N
        panelRole.add(jLabel6, new org.palooca.dialogs.awtextra.AbsoluteConstraints(360, 60, -1, -1));

        jLabel7.setText("Delete      : D"); // NOI18N
        jLabel7.setName("jLabel7"); // NOI18N
        panelRole.add(jLabel7, new org.palooca.dialogs.awtextra.AbsoluteConstraints(360, 80, -1, -1));

        jLabel19.setText("Write        : W"); // NOI18N
        jLabel19.setName("jLabel19"); // NOI18N
        panelRole.add(jLabel19, new org.palooca.dialogs.awtextra.AbsoluteConstraints(360, 100, -1, -1));

        jLabel20.setText("Read        : R"); // NOI18N
        jLabel20.setName("jLabel20"); // NOI18N
        panelRole.add(jLabel20, new org.palooca.dialogs.awtextra.AbsoluteConstraints(360, 120, -1, -1));

        jLabel21.setText(bundle.getString("RightOptions")); // NOI18N
        jLabel21.setName("jLabel21"); // NOI18N
        panelRole.add(jLabel21, new org.palooca.dialogs.awtextra.AbsoluteConstraints(350, 30, -1, 20));

        jLabel30.setText("None        : N"); // NOI18N
        jLabel30.setName("jLabel30"); // NOI18N
        panelRole.add(jLabel30, new org.palooca.dialogs.awtextra.AbsoluteConstraints(360, 140, -1, -1));

        jSplitPane1.setRightComponent(panelRole);

        panelAttributes.setName("panelAttributes"); // NOI18N
        panelAttributes.setPreferredSize(new java.awt.Dimension(550, 395));
        panelAttributes.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        panelAttributes.add(jScrollPane15, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 30, 230, 330));

        jLabel22.setText(bundle.getString("Attributes")); // NOI18N
        jLabel22.setName("jLabel22"); // NOI18N
        panelAttributes.add(jLabel22, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        panelAttributes.add(btnAttributeNew, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 370, 25, -1));
        ...
        panelAttributes.add(btnAttributeDelete, new org.palooca.dialogs.awtextra.AbsoluteConstraints(40, 370, 25, -1));
        ...
        panelAttributes.add(btnAttributeEdit, new org.palooca.dialogs.awtextra.AbsoluteConstraints(70, 370, 25, -1));
        ...
        panelAttributes.add(btnAttributeNumeric, new org.palooca.dialogs.awtextra.AbsoluteConstraints(180, 370, 25, -1));
        ...
        panelAttributes.add(btnAttributeString, new org.palooca.dialogs.awtextra.AbsoluteConstraints(210, 370, 25, -1));

        jSplitPane1.setRightComponent(panelAttributes);

        panelDimensionRights.setName("panelDimensionRights"); // NOI18N
        panelDimensionRights.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());
        ...
        panelDimensionRights.add(btnEditDimensionRights, new org.palooca.dialogs.awtextra.AbsoluteConstraints(20, 80, 190, -1));

        jLabel34.setText(bundle.getString("EditDimRights")); // NOI18N
        jLabel34.setName("jLabel34"); // NOI18N
        panelDimensionRights.add(jLabel34, new org.palooca.dialogs.awtextra.AbsoluteConstraints(20, 20, 570, 20));

        jLabel36.setText(bundle.getString("EditDimRightsInfo2")); // NOI18N
        jLabel36.setName("jLabel36"); // NOI18N
        panelDimensionRights.add(jLabel36, new org.palooca.dialogs.awtextra.AbsoluteConstraints(20, 40, -1, -1));
        ...
        panelCubeRights.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());

        jScrollPane19.setName("jScrollPane19"); // NOI18N

        tableCubeRights.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        panelCubeRights.add(jScrollPane19, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 30, 330, 360));

        jLabel10.setText(bundle.getString("CubeRights")); // NOI18N
        jLabel10.setName("jLabel10"); // NOI18N
        panelCubeRights.add(jLabel10, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        jLabel28.setText(bundle.getString("RightOptions")); // NOI18N
        jLabel28.setName("jLabel28"); // NOI18N
        panelCubeRights.add(jLabel28, new org.palooca.dialogs.awtextra.AbsoluteConstraints(350, 30, -1, 20));

        jLabel23.setText("Undefined: No Text"); // NOI18N
        jLabel23.setName("jLabel23"); // NOI18N
        panelCubeRights.add(jLabel23, new org.palooca.dialogs.awtextra.AbsoluteConstraints(360, 160, -1, -1));

        jLabel24.setText("Splash      : S"); // NOI18N
        jLabel24.setName("jLabel24"); // NOI18N
        panelCubeRights.add(jLabel24, new org.palooca.dialogs.awtextra.AbsoluteConstraints(360, 60, -1, -1));

        jLabel25.setText("Delete      : D"); // NOI18N
        jLabel25.setName("jLabel25"); // NOI18N
        panelCubeRights.add(jLabel25, new org.palooca.dialogs.awtextra.AbsoluteConstraints(360, 80, -1, -1));

        jLabel26.setText("Write        : W"); // NOI18N
        jLabel26.setName("jLabel26"); // NOI18N
        panelCubeRights.add(jLabel26, new org.palooca.dialogs.awtextra.AbsoluteConstraints(360, 100, -1, -1));

        jLabel27.setText("Read        : R"); // NOI18N
        jLabel27.setName("jLabel27"); // NOI18N
        panelCubeRights.add(jLabel27, new org.palooca.dialogs.awtextra.AbsoluteConstraints(360, 120, -1, -1));

        jLabel32.setText("None        : N"); // NOI18N
        jLabel32.setName("jLabel32"); // NOI18N
        panelCubeRights.add(jLabel32, new org.palooca.dialogs.awtextra.AbsoluteConstraints(360, 140, -1, -1));

        jSplitPane1.setRightComponent(panelCubeRights);

        panelCube.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        panelCube.setName("panelCube"); // NOI18N
        panelCube.setLayout(new org.palooca.dialogs.awtextra.AbsoluteLayout());

        jLabel29.setText(bundle.getString("FilledCellCount")); // NOI18N
        jLabel29.setName("jLabel29"); // NOI18N
        panelCube.add(jLabel29, new org.palooca.dialogs.awtextra.AbsoluteConstraints(20, 50, -1, -1));

        lblFilledCellCount.setText("jLabel30");
        lblFilledCellCount.setName("lblFilledCellCount"); // NOI18N
        panelCube.add(lblFilledCellCount, new org.palooca.dialogs.awtextra.AbsoluteConstraints(140, 50, -1, -1));

        jLabel31.setText(bundle.getString("CellCount")); // NOI18N
        jLabel31.setName("jLabel31"); // NOI18N
        panelCube.add(jLabel31, new org.palooca.dialogs.awtextra.AbsoluteConstraints(20, 20, -1, -1));

        lblCellCount.setText("jLabel30");
        lblCellCount.setName("lblCellCount"); // NOI18N
        panelCube.add(lblCellCount, new org.palooca.dialogs.awtextra.AbsoluteConstraints(140, 20, -1, -1));

        jLabel33.setText(bundle.getString("Status")); // NOI18N
        jLabel33.setName("jLabel33"); // NOI18N
        panelCube.add(jLabel33, new org.palooca.dialogs.awtextra.AbsoluteConstraints(20, 80, -1, -1));

        lblStatus.setText("jLabel30");
        lblStatus.setName("lblStatus"); // NOI18N
        panelCube.add(lblStatus, new org.palooca.dialogs.awtextra.AbsoluteConstraints(140, 80, -1, -1));
        ...
        panelCube.add(btnDeleteCubeValues, new org.palooca.dialogs.awtextra.AbsoluteConstraints(20, 210, 220, -1));
        ...
        panelCube.add(jLabel35, new org.palooca.dialogs.awtextra.AbsoluteConstraints(20, 110, -1, -1));
        ...
        panelCube.add(jScrollPane9, new org.palooca.dialogs.awtextra.AbsoluteConstraints(140, 110, 270, 80));

        jSplitPane1.setRightComponent(panelCube);

        getContentPane().add(jSplitPane1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(17, 50, 790, 410));
        ...
        getContentPane().add(jPanel1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(780, 490, 42, 14));
    ...
    private void treeOverviewKeyPressed(KeyEvent evt) {//GEN-FIRST:event_treeOverviewKeyPressed
...
//                showAttributesPanel();
    ...
    private void treeDimensionsKeyPressed(KeyEvent evt) {//GEN-FIRST:event_treeDimensionsKeyPressed
    ...
    private void treeCubesKeyPressed(KeyEvent evt) {//GEN-FIRST:event_treeCubesKeyPressed
    ...
    private void treeElementsKeyPressed(KeyEvent evt) {//GEN-FIRST:event_treeElementsKeyPressed
    ...
    private void treeConsolidationKeyPressed(KeyEvent evt) {//GEN-FIRST:event_treeConsolidationKeyPressed
        if (editConsolidationMode == true) {
            ...
            synchronized(connectionHandler) {
                ...
                for (int i = 0; i < connections.size() && connectionInfo == null; i++) {
                    if (connections.get(i).getName().equalsIgnoreCase(editor.txtName.getText())) {
                        ...
                        JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Connection_name_already_used."), ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Error"), JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }
...
//                 connectionInfo.removeConnectionChangeListener(this); TODO
    ...
    private void treeDatabasesKeyPressed(KeyEvent evt) {//GEN-FIRST:event_treeDatabasesKeyPressed
        /*
    ...
    private void treeGroupsKeyPressed(KeyEvent evt) {//GEN-FIRST:event_treeGroupsKeyPressed
    ...
    private void treeUsersKeyPressed(KeyEvent evt) {//GEN-FIRST:event_treeUsersKeyPressed
    ...
    private void treeRolesKeyPressed(KeyEvent evt) {//GEN-FIRST:event_treeRolesKeyPressed
    ...
    private void treeAttributesKeyPressed(KeyEvent evt) {//GEN-FIRST:event_treeAttributesKeyPressed
...
//            }
        if (!isReadOnly()) {
            ...
            if (node instanceof CubeTreeNode) {
                if (JOptionPane.showConfirmDialog(this,
                        ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("DeleteCubeValues"),
                        ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Confirmation"),
    ...
    private void mnuElementCountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuElementCountActionPerformed
        ...
        JOptionPane.showMessageDialog(this, ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("NumberElements") + " " + count,
                ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Information"),
            ...
            if (searchDialog.getModalResult() == JOptionPane.OK_OPTION) {
                if (PaloDialogUtilities.searchForNode(treeElements, searchDialog.getSearchText(), null, rootNodeElements, false, true) == false) {
                    JOptionPane.showMessageDialog(this,
                            ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("SearchNotFound"),
                            ResourceBundle.getBundle("org/palooca/dialogs/PalOOCaDialogs").getString("Information"), JOptionPane.INFORMATION_MESSAGE);
                }
            }
    ...
    private JTree treeConsolidation;
    private JTree treeCubes;
    private JTree treeDatabases;
    private JTree treeDimensions;
    private JTree treeElements;
    private JTree treeGroups;
    private JTree treeHierarchy;
    private JTree treeOverview;
    private JTree treeRoles;
