...
public class ElementBrowserDialog extends PaloDialogUtilities
    ...
    private void initComponents() {
        ...
        mnuSelectAll.addActionListener(this::mnuSelectAllActionPerformed);
        pmElements.add(mnuSelectAll);

        mnuDeselectAll.setText(resourceBundle.getString("Deselect_all")); // NOI18N
        mnuDeselectAll.addActionListener(this::mnuDeselectAllActionPerformed);
        pmElements.add(mnuDeselectAll);

        mnuInvertSelection.setText(resourceBundle.getString("Invert_selection")); // NOI18N
        mnuInvertSelection.addActionListener(this::mnuInvertSelectionActionPerformed);
        ...
        mnuExpandAll.addActionListener(this::mnuExpandAllActionPerformed);
        pmElements.add(mnuExpandAll);

        mnuCollapseAll.setText(resourceBundle.getString("Collapse_all_nodes")); // NOI18N
        mnuCollapseAll.addActionListener(this::mnuCollapseAllActionPerformed);
        ...
        treeElements.addTreeSelectionListener(this::treeElementsValueChanged);
        jScrollPane1.setViewportView(treeElements);

        getContentPane().add(jScrollPane1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 60, 230, 340));

        btnOK.setText(resourceBundle.getString("OK")); // NOI18N
        btnOK.addActionListener(this::btnOKActionPerformed);
        getContentPane().add(btnOK, new org.palooca.dialogs.awtextra.AbsoluteConstraints(560, 30, 90, -1));

        btnCancel.setText(resourceBundle.getString("Cancel")); // NOI18N
        btnCancel.addActionListener(this::btnCancelActionPerformed);
        getContentPane().add(btnCancel, new org.palooca.dialogs.awtextra.AbsoluteConstraints(560, 60, 90, -1));
        ...
        jButtonExpand.addActionListener(this::jButtonExpandActionPerformed);
        getContentPane().add(jButtonExpand, new org.palooca.dialogs.awtextra.AbsoluteConstraints(80, 30, 25, -1));

        jButtonCollapse.setText(bundle.getString("Collapse")); // NOI18N
        jButtonCollapse.setMargin(new java.awt.Insets(2, 2, 2, 2));
        jButtonCollapse.addActionListener(this::jButtonCollapseActionPerformed);
        getContentPane().add(jButtonCollapse, new org.palooca.dialogs.awtextra.AbsoluteConstraints(110, 30, 25, -1));

        jButtonExpandAll.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/images/expandAll.png")))); // NOI18N
        jButtonExpandAll.setText(bundle.getString("ExpandAll")); // NOI18N
        jButtonExpandAll.setMargin(new java.awt.Insets(2, 2, 2, 2));
        jButtonExpandAll.addActionListener(this::jButtonExpandAllActionPerformed);
        getContentPane().add(jButtonExpandAll, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 30, -1, -1));
        ...
        jButtonCollapseAll.addActionListener(this::jButtonCollapseAllActionPerformed);
        getContentPane().add(jButtonCollapseAll, new org.palooca.dialogs.awtextra.AbsoluteConstraints(40, 30, -1, -1));
        getContentPane().add(jTextFieldSearch, new org.palooca.dialogs.awtextra.AbsoluteConstraints(290, 400, 120, -1));
        ...
        getContentPane().add(jButtonSearch, new org.palooca.dialogs.awtextra.AbsoluteConstraints(420, 400, 130, -1));
        ...
        getContentPane().add(jButtonSelectAll, new org.palooca.dialogs.awtextra.AbsoluteConstraints(290, 340, 120, -1));
        ...
        jButtonSelectChildren.addActionListener(this::jButtonSelectChildrenActionPerformed);
        getContentPane().add(jButtonSelectChildren, new org.palooca.dialogs.awtextra.AbsoluteConstraints(420, 340, 130, -1));

        jButtonSelect1.setText("1"); // NOI18N
        jButtonSelect1.setMargin(new java.awt.Insets(2, 2, 2, 2));
        jButtonSelect1.addActionListener(this::jButtonSelect1ActionPerformed);
        getContentPane().add(jButtonSelect1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(290, 370, -1, -1));

        jButtonSelect2.setText("2"); // NOI18N
        jButtonSelect2.setMargin(new java.awt.Insets(2, 2, 2, 2));
        jButtonSelect2.addActionListener(this::jButtonSelect2ActionPerformed);

        getContentPane().add(jButtonSelect2, new org.palooca.dialogs.awtextra.AbsoluteConstraints(310, 370, -1, -1));

        jButtonSelect3.setText("3"); // NOI18N
        jButtonSelect3.setMargin(new java.awt.Insets(2, 2, 2, 2));
        jButtonSelect3.addActionListener(this::jButtonSelect3ActionPerformed);
        getContentPane().add(jButtonSelect3, new org.palooca.dialogs.awtextra.AbsoluteConstraints(330, 370, -1, -1));

        jButtonSelect4.setText("4"); // NOI18N
        jButtonSelect4.setMargin(new java.awt.Insets(2, 2, 2, 2));
        jButtonSelect4.addActionListener(this::jButtonSelect4ActionPerformed);
        getContentPane().add(jButtonSelect4, new org.palooca.dialogs.awtextra.AbsoluteConstraints(350, 370, -1, -1));

        jButtonSelect5.setText("5"); // NOI18N
        jButtonSelect5.setMargin(new java.awt.Insets(2, 2, 2, 2));
        jButtonSelect5.addActionListener(this::jButtonSelect5ActionPerformed);
        getContentPane().add(jButtonSelect5, new org.palooca.dialogs.awtextra.AbsoluteConstraints(370, 370, -1, -1));

        jButtonSelectB.setText("B"); // NOI18N
        jButtonSelectB.setMargin(new java.awt.Insets(2, 2, 2, 2));
        jButtonSelectB.addActionListener(this::jButtonSelectBActionPerformed);
        getContentPane().add(jButtonSelectB, new org.palooca.dialogs.awtextra.AbsoluteConstraints(395, 370, -1, -1));
        ...
        jListElements.addListSelectionListener(this::listElementsValueChanged);
        jScrollPane2.setViewportView(jListElements);

        getContentPane().add(jScrollPane2, new org.palooca.dialogs.awtextra.AbsoluteConstraints(290, 60, 260, 270));

        jLabel1.setText(bundle.getString("Hierarchy")); // NOI18N
        getContentPane().add(jLabel1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        jLabel2.setText(bundle.getString("PickList")); // NOI18N
        getContentPane().add(jLabel2, new org.palooca.dialogs.awtextra.AbsoluteConstraints(290, 10, -1, -1));

        jButtonMoveRight.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/images/MoveNext.png")))); // NOI18N
        jButtonMoveRight.addActionListener(this::jButtonMoveRightActionPerformed);
        getContentPane().add(jButtonMoveRight, new org.palooca.dialogs.awtextra.AbsoluteConstraints(250, 180, 25, -1));

        jButtonMoveLeft.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/images/MovePrevious.png")))); // NOI18N
        jButtonMoveLeft.addActionListener(this::jButtonMoveLeftActionPerformed);
        getContentPane().add(jButtonMoveLeft, new org.palooca.dialogs.awtextra.AbsoluteConstraints(250, 210, 25, -1));

        jButtonSortUp.setText(bundle.getString("SortUp")); // NOI18N
        jButtonSortUp.setMargin(new java.awt.Insets(2, 4, 2, 4));
        jButtonSortUp.addActionListener(this::jButtonSortUpActionPerformed);
        getContentPane().add(jButtonSortUp, new org.palooca.dialogs.awtextra.AbsoluteConstraints(290, 30, 83, -1));

        jButtonSortDown.setText(bundle.getString("SortDown")); // NOI18N
        jButtonSortDown.addActionListener(this::jButtonSortDownActionPerformed);
        getContentPane().add(jButtonSortDown, new org.palooca.dialogs.awtextra.AbsoluteConstraints(380, 30, -1, -1));

        jButtonClear.setText(bundle.getString("Clear")); // NOI18N
        jButtonClear.addActionListener(this::jButtonClearActionPerformed);
        getContentPane().add(jButtonClear, new org.palooca.dialogs.awtextra.AbsoluteConstraints(470, 30, 80, -1));

        jButtonMoveUp.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/images/MoveUp.png")))); // NOI18N
        jButtonMoveUp.addActionListener(this::jButtonMoveUpActionPerformed);
        getContentPane().add(jButtonMoveUp, new org.palooca.dialogs.awtextra.AbsoluteConstraints(250, 140, 25, -1));

        jButtonMoveDown.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/images/MoveDown.PNG")))); // NOI18N
        jButtonMoveDown.addActionListener(this::jButtonMoveDownActionPerformed);
        getContentPane().add(jButtonMoveDown, new org.palooca.dialogs.awtextra.AbsoluteConstraints(250, 250, 25, -1));

        jLabel3.setText(bundle.getString("UseAlias")); // NOI18N
        getContentPane().add(jLabel3, new org.palooca.dialogs.awtextra.AbsoluteConstraints(10, 420, -1, -1));

        cmbAlias.setRenderer(new AttributeComboBoxRenderer());
        cmbAlias.addItemListener(this::cmbAliasItemStateChanged);
        cmbAlias.addActionListener(this::cmbAliasActionPerformed);
        getContentPane().add(cmbAlias, new org.palooca.dialogs.awtextra.AbsoluteConstraints(80, 417, 160, -1));
        ...
        btnInvertSelection.addActionListener(this::btnInvertSelectionActionPerformed);
        getContentPane().add(btnInvertSelection, new org.palooca.dialogs.awtextra.AbsoluteConstraints(420, 370, 130, -1));

        jLabel7.setText(bundle.getString("ShiftTip")); // NOI18N
        getContentPane().add(jLabel7, new org.palooca.dialogs.awtextra.AbsoluteConstraints(290, 430, -1, -1));
        ...
        getContentPane().add(jPanel1, new org.palooca.dialogs.awtextra.AbsoluteConstraints(600, 410, 60, 50));

        btnHierarchy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/showHierarchy.png"))); // NOI18N
        btnHierarchy.addActionListener(this::btnHierarchyActionPerformed);
        getContentPane().add(btnHierarchy, new org.palooca.dialogs.awtextra.AbsoluteConstraints(215, 30, 25, -1));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void mnuCollapseAllActionPerformed(ActionEvent evt) {//GEN-FIRST:event_mnuCollapseAllActionPerformed
    ...
    private void mnuExpandAllActionPerformed(ActionEvent evt) {//GEN-FIRST:event_mnuExpandAllActionPerformed
    ...
    private void mnuInvertSelectionActionPerformed(ActionEvent evt) {//GEN-FIRST:event_mnuInvertSelectionActionPerformed
        int cnt = treeElements.getRowCount();
        int amount = 0;
    ...
    private void mnuDeselectAllActionPerformed(ActionEvent evt) {//GEN-FIRST:event_mnuDeselectAllActionPerformed
        for (int i = 0; i < treeElements.getRowCount(); i++) {
    ...
    private void mnuSelectAllActionPerformed(ActionEvent evt) {//GEN-FIRST:event_mnuSelectAllActionPerformed
        for (int i = 0; i < treeElements.getRowCount(); i++) {
    ...
    private void jButtonExpandActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonExpandActionPerformed
        preExpansionStateChange(true);
        expand(treeElements);
        postExpansionStateChange(true);
}//GEN-LAST:event_jButtonExpandActionPerformed

    private void jButtonCollapseActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonCollapseActionPerformed
        preExpansionStateChange(false);
        collapse(treeElements);
        postExpansionStateChange(false);
    }//GEN-LAST:event_jButtonCollapseActionPerformed

    private void jButtonExpandAllActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonExpandAllActionPerformed
        preExpansionStateChange(true);
        expandAll(treeElements, true);
        postExpansionStateChange(true);
    }//GEN-LAST:event_jButtonExpandAllActionPerformed

    private void jButtonCollapseAllActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonCollapseAllActionPerformed
        preExpansionStateChange(false);
        expandAll(treeElements, false);
        postExpansionStateChange(false);
    ...
    private void jButtonSelectChildrenActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonSelectChildrenActionPerformed
    ...
    private void jButtonSelect1ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonSelect1ActionPerformed
        selectByLevel(1, (evt.getModifiers() & ActionEvent.SHIFT_MASK) != 0);
    }//GEN-LAST:event_jButtonSelect1ActionPerformed

    private void jButtonSelect2ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonSelect2ActionPerformed
        selectByLevel(2, (evt.getModifiers() & ActionEvent.SHIFT_MASK) != 0);
    }//GEN-LAST:event_jButtonSelect2ActionPerformed

    private void jButtonSelect3ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonSelect3ActionPerformed
        selectByLevel(3, (evt.getModifiers() & ActionEvent.SHIFT_MASK) != 0);
    }//GEN-LAST:event_jButtonSelect3ActionPerformed

    private void jButtonSelect4ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonSelect4ActionPerformed
        selectByLevel(4, (evt.getModifiers() & ActionEvent.SHIFT_MASK) != 0);
    }//GEN-LAST:event_jButtonSelect4ActionPerformed

    private void jButtonSelect5ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonSelect5ActionPerformed
        selectByLevel(5, ((evt.getModifiers() & ActionEvent.SHIFT_MASK) != 0) ? true : false);
    }//GEN-LAST:event_jButtonSelect5ActionPerformed

    private void jButtonSelectBActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonSelectBActionPerformed
        int cnt = treeElements.getRowCount();
    ...
    private void jButtonMoveRightActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonMoveRightActionPerformed
    ...
    private void jButtonMoveLeftActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonMoveLeftActionPerformed
    ...
    private void jButtonMoveUpActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonMoveUpActionPerformed
        int selRows[] = jListElements.getSelectedIndices();
        Object obj;
    ...
    private void jButtonMoveDownActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonMoveDownActionPerformed
        int selRows[] = jListElements.getSelectedIndices();
        Object obj;
    ...
    private void jButtonSortUpActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonSortUpActionPerformed
        sortList(true);
    }//GEN-LAST:event_jButtonSortUpActionPerformed

    private void jButtonSortDownActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonSortDownActionPerformed
        sortList(false);
    }//GEN-LAST:event_jButtonSortDownActionPerformed

    private void cmbAliasItemStateChanged(ItemEvent evt) {//GEN-FIRST:event_cmbAliasItemStateChanged
    ...
    private void cmbAliasActionPerformed(ActionEvent evt) {//GEN-FIRST:event_cmbAliasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbAliasActionPerformed

    private void btnInvertSelectionActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnInvertSelectionActionPerformed
        int cnt = treeElements.getRowCount();
        int amount = 0;
    ...
    private void btnHierarchyActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnHierarchyActionPerformed
