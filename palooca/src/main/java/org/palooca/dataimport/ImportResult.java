...
public abstract class ImportResult{
    ...
    // Static members
    protected static Vector<ImportFunctionListener> importFuncListeners = new Vector<>();
    protected static Vector<ExternalImportListener> externalImportListeners = new Vector<>();
    ...
    //...therefore we use a state variable and do the import during a recalculated()
    ...
    protected static Vector<String> importErrors = new Vector<>();
