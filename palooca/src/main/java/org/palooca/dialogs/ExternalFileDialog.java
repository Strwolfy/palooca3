 ...
 */
public class ExternalFileDialog extends JDialog
    implements ExternalDataHandler
{
    ...
    private void initComponents() {
        ...
        jLabel1 = new JLabel();
        rbtTab = new JRadioButton();
        rbtComma = new JRadioButton();
        rbtSemicolon = new JRadioButton();
        rbtSpace = new JRadioButton();
        rbtUserDefined = new JRadioButton();
        txtUserDefined = new JTextField();
        jLabel2 = new JLabel();
        txtDecimalPoint = new JTextField();
        chbShipHeader = new JCheckBox();
    ...
    public String getDelimiter(){
        if (rbgDelimiter.getSelection().getActionCommand().equals("USER")){
            ...
            // In future would put an indicator on the screen
    ...
    private JCheckBox chbShipHeader;
    private JLabel jLabel1;
    private JLabel jLabel2;
    private JLabel lblFilePath;
    private ButtonGroup rbgDelimiter;
    private JRadioButton rbtComma;
    private JRadioButton rbtSemicolon;
    private JRadioButton rbtSpace;
    private JRadioButton rbtTab;
    private JRadioButton rbtUserDefined;
    private JTextField txtDecimalPoint;
    private JTextField txtFilePath;
    private JTextField txtUserDefined;
    ...
    public void doEntryImport() {
        ...
        try{
            ...
            XCellRangeFormula cellRangeFormula = UnoRuntime.queryInterface(XCellRangeFormula.class, cellRange);
            ...
            for (int col = 0; col < entries.length; col++){
                ...
                // If the decimal character is different from the default oo value
