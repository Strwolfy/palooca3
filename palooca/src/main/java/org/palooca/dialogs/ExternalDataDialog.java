...
public class ExternalDataDialog extends javax.swing.JDialog
    ...
    private final ImportFunctionsDialog importFunctionsDialog;
     ...
     * @return If the import was set up successfully.
     */
        ...
        protected Void doInBackground() throws Exception {
            ...
            try{
                while (externalDataHandler.hasMoreEntries()){
                    ...
                    // Cache the last entry, so it is available after the screen is closed
